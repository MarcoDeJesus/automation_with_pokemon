...
@mytag
Scenario Outline: The Data from Pokemon API should match the Pokemon DataBase detail page - With Navigation
...
Scenario Outline: The Data from Pokemon API should match the Pokemon DataBase detail page - With Direct Link
	Given that the test user has selected a the '<name>' Pokemon for this test
